...
/* harmony import */ var _components_slider__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/slider */ "./source/js/components/slider.js");
...
(0,_functions_customFunctions__WEBPACK_IMPORTED_MODULE_1__.elementHeight)(sortBlock, "sorting-height");
...
productsSlider.forEach(item => {
  ...
  if (fakeContainer) {
    (0,_functions_customFunctions__WEBPACK_IMPORTED_MODULE_2__.addCustomClass)(fakeContainer, 'swiper-container');
    (0,_functions_customFunctions__WEBPACK_IMPORTED_MODULE_2__.addCustomClass)(fakeWrapper, 'swiper-wrapper');
    fakeSlide.forEach(function (fakeSlide) {
      const liElement = document.createElement("li");
      (0,_functions_customFunctions__WEBPACK_IMPORTED_MODULE_2__.addCustomClass)(liElement, 'swiper-slide');
...
document.querySelectorAll('.product-card__like').forEach(item => {
  item.addEventListener('click', e => {
    e.preventDefault();
    (0,_functions_customFunctions__WEBPACK_IMPORTED_MODULE_2__.toggleCustomClass)(item, 'active');
  });
});

/***/ }),

/***/ "./source/js/components/smallJS.js":
/*!*****************************************!*\
  !*** ./source/js/components/smallJS.js ***!
  \*****************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
(0,_functions_customFunctions__WEBPACK_IMPORTED_MODULE_0__.addClassInArray)(document.querySelectorAll('.woocommerce-pagination'), 'custom-pagination');
for (const item of document.querySelectorAll('.category-section__wrapper')) {
  ...
  currentItems.forEach(card => {
    ...
    (0,_functions_customFunctions__WEBPACK_IMPORTED_MODULE_0__.addCustomClass)(newTagElement, 'products__item');
...
const elementHeight = (el, variableName) => {
  ...
  if (el) {
    ...
    const handleResize = function () {
      let time = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 250;
