...
<input type="hidden" name="act" value="upload" />
  ...
  <table width="75%" cellpadding="3" cellspacing="3" class="widefat post fixed" >
    ...
    <td>    </tr>
	<tr>
      <td colspan="2"><p style="color:#FF0000"><u><?php _e('Note');?></u>:- <?php _e('Please make sure "post_title" column should included in the CSV file otherwise system will never accept the data. New data will insert every time as per the file you are uploading.');?></p></td>
    </tr>
	 <tr>
	 <?php global $plugin_foldername;?>
      <td colspan="2"><b><a href="<?php echo WP_PLUGIN_URL.'/'.$plugin_foldername; ?>/sample.csv"><?php _e('Click to Download Sample CSV file');?></a></b></td>
    </tr>
  </table>
</form>
<script>
