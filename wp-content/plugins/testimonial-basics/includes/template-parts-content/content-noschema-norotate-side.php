 ...
 * the shortcode. It uses no schema, no rotation, side meta, and custom or basic formats.
 *
...
?>
<div class="katb_test_wrap<?php echo esc_attr( $format ); ?>_side_meta">
	<?php
	...
	for ( $i = 0; $i < $katb_tnumber; $i++ ) {
		...
		?>
		<div class="katb_test_box<?php echo esc_attr( $format ); ?>_side_meta">
