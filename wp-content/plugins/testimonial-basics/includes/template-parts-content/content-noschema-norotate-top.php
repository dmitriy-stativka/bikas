 ...
 * the shortcode. It uses no schema, no rotation, top meta, and custom or basic formats.
 *
...
?>
<div class="katb_test_wrap<?php echo esc_html( $format ); ?>">
	<?php
	...
	for ( $i = 0; $i < $katb_tnumber; $i++ ) {
		...
		?>
		<div class="katb_test_box<?php echo esc_html( $format ); ?>">
