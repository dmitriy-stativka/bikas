 ...
 * the shortcode. It uses no schema, rotation, bottom meta, and custom or basic formats.
 *
...
<div <?php echo $katb_height_option_outside;// WPCS: XSS ok. ?> class="katb_test_wrap<?php echo esc_attr( $format ); ?> katb_rotate" data-katb_speed="<?php echo esc_attr( $katb_speed ); ?>" data-katb_transition="<?php echo esc_attr( $katb_transition ); ?>">
	...
	for ( $i = 0; $i < $katb_tnumber; $i++ ) {
		...
		?>
		<div <?php echo esc_attr( $katb_height_option ); ?> class="katb_test_box<?php echo esc_attr( $format ); ?> <?php echo esc_attr( $show_noshow ); ?> ">
		...
		if ( true === $use_excerpts && false !== $katb_excerpt_required ) {
