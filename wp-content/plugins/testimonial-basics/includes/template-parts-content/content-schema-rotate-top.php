 ...
 * the shortcode. It uses schema, rotation, top meta, and custom or basic formats.
 *
...
<div itemscope itemtype="http://schema.org/Organization">
	...
	$source = 'content';
	// Get the schema html.
	echo katb_company_aggregate_display( $use_formatted_display, $group_name, 'Top Meta' ); // WPCS: XSS ok.
	if ( true === $display_reviews ) {
	?>
		<div <?php echo $katb_height_option_outside;// WPCS: XSS ok. ?> class="katb_test_wrap<?php echo esc_attr( $format ); ?> katb_rotate" data-katb_speed="<?php echo esc_attr( $katb_speed ); ?>" data-katb_transition="<?php echo esc_attr( $katb_transition ); ?>">
		<?php
		...
		for ( $i = 0; $i < $katb_tnumber; $i++ ) {
			...
			?>
			<div <?php echo esc_attr( $katb_height_option ); ?> class="katb_test_box<?php echo esc_attr( $format ); ?> <?php echo esc_attr( $show_noshow ); ?>" itemscope itemtype="http://schema.org/Review">
