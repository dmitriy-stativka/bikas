 ...
 * the shortcode. It uses schema, no rotation, side meta, and custom or basic formats.
 *
...
<div itemscope itemtype="http://schema.org/Organization">
	...
	<div class="katb_test_wrap<?php echo esc_attr( $format ); ?>_side_meta">
		...
		for ( $i = 0; $i < $katb_tnumber; $i++ ) {
			...
			?>
			<div class="katb_test_box<?php echo esc_attr( $format ); ?>_side_meta" itemscope itemtype="http://schema.org/Review">
