 ...
 *
 * Array that holds all of the defined values for Testimonial Basics Plugin Options.
 * If the user has not specified a value for a given Theme option, then the option's default value is used instead.
 *
...
function katb_get_options() {
	...
	$katb_options_set       = get_option( 'katb_testimonial_basics_options', array() );
	foreach ( $katb_option_parameters as $option ) {
		if ( 'checkbox' === $option['type'] ) {
			if ( ! isset( $katb_options_set[ $option['name'] ] ) ) {
				$katb_options[ $option['name'] ] = $option['default'];
			} elseif ( false === $katb_options_set[ $option['name'] ] || 0 === $katb_options_set[ $option['name'] ] ) {
				$katb_options[ $option['name'] ] = false;
			} else {
				$katb_options[ $option['name'] ] = true;
			}
		} else {
			if ( ! isset( $katb_options_set[ $option['name'] ] ) ) {
				$katb_options[ $option['name'] ] = $option['default'];
			} else {
				$katb_options[ $option['name'] ] = $katb_options_set[ $option['name'] ];
			}
		}
	}
	return $katb_options;
 ...
 *
 * Array that holds all of the deault values for Testimonial Basics Plugin Options.
 *
 ...
 *
 * Array that holds all of the parameters for Testimonial Basics Plugin Options.
 *
 * @return array $options all elements for each option
 */
function katb_get_option_parameters() {
	global $katb_options;
	if ( ! isset( $katb_options['katb_custom_field_1_name'] ) || NULL === $katb_options['katb_custom_field_1_name'] ) {
		$katb_options['katb_custom_field_1_name'] = 'Custom 1';
	}
	if ( ! isset( $katb_options['katb_custom_field_2_name'] ) || NULL === $katb_options['katb_custom_field_2_name'] ) {
		$katb_options['katb_custom_field_2_name'] = 'Custom 2';
	}
	$options = array(
		/* ----------- General -------------------------------------- */
		...
		'katb_use_gdpr'                        => array(
			'name'        => 'katb_use_gdpr',
			'title'       => __( 'Use General Data Protection', 'testimonial-basics' ),
			'type'        => 'checkbox',
			'description' => __( 'General Data Protection Regulation (GDPR) requirements are set up on input forms and testimonials.', 'testimonial-basics' ),
			'section'     => 'gdpr',
			'tab'         => 'general',
			'default'     => false,
			'class'       => 'checkbox',
		),
		'katb_gdpr_save_data_note'             => array(
			'name'        => 'katb_gdpr_save_data_note',
			'title'       => __( 'Save data approval note', 'testimonial-basics' ),
			'type'        => 'text',
			'description' => __( 'Note to be added to the check box on testimonial input forms.', 'testimonial-basics' ),
			'section'     => 'gdpr',
			'tab'         => 'general',
			'default'     => __( 'Check to approve saving of testimonial data', 'testimonial-basics' ),
			'class'       => 'nohtml',
		),
		'katb_gdpr_remove_permalink'           => array(
			'name'        => 'katb_gdpr_remove_permalink',
			'title'       => __( 'Request testimonial remove page permalink.', 'testimonial-basics' ),
			'type'        => 'text',
			'description' => __( 'Include your page address set up for GDPR testimonial removal requests. Leave blank if you are not using this feature.', 'testimonial-basics' ),
			'section'     => 'gdpr',
			'tab'         => 'general',
			'default'     => '',
			'class'       => 'url',
		),
		'katb_remove_page_intro'               => array(
			'name'        => 'katb_remove_page_intro',
			'title'       => __( 'Request for Testimonial Removal Introduction', 'testimonial-basics' ),
			'type'        => 'textarea',
			'description' => esc_html__( 'Add your introduction text for the request testimonial removal page, html not allowed. If deleted and left blank you can leave instructions in the page content.', 'testimonial-basics' ) . ' ' .
							esc_html__( 'Example:', 'testimonial-basics' ) . ' ' .
							esc_html__( 'General Data Protection Regulation (GDPR) requires the author of this testimonial be allowed to have it removed if requested.', 'testimonial-basics' ) . ' ' .
							esc_html__( 'Please provide your email and an optional comment reason for removal, in the form below. ', 'testimonial-basics' ) . ' ' .
							esc_html__( 'The administrator of this site will be contacted and the testimonial will be requested for removal. ', 'testimonial-basics' ) . ' ' .
							esc_html__( 'Note that the email you provide below and the original author email must match or the testimonial may not be removed. ', 'testimonial-basics' ),
			'section'     => 'gdpr',
			'tab'         => 'general',
			'default'     => esc_html__( 'General Data Protection Regulation (GDPR) requires the author of this testimonial be allowed to have it removed if requested.', 'testimonial-basics' ) . ' ' .
							esc_html__( 'Please provide your email and an optional comment reason for removal, in the form below. ', 'testimonial-basics' ) . ' ' .
							esc_html__( 'The administrator of this site will be contacted and the testimonial will be requested for removal. ', 'testimonial-basics' ) . ' ' .
							esc_html__( 'Note that the email you provide below and the original author email must match or the testimonial may not be removed. ', 'testimonial-basics' ),
			'class'       => 'nohtml',
		),
		'katb_remove_page_direct_access'       => array(
			'name'        => 'katb_remove_page_direct_access',
			'title'       => __( 'Request for Testimonial Removal No Testimonial Selected', 'testimonial-basics' ),
			'type'        => 'textarea',
			'description' => esc_html__( 'Add a message if the testimonial removal page is directly accessed, no html allowed. If deleted and left blank you can leave instructions in the page content.', 'testimonial-basics' ) . ' ' .
							esc_html__( 'Example:', 'testimonial-basics' ) . ' ' .
							esc_html__( 'You have not selected a testimonial to remove. ', 'testimonial-basics' ) . ' ' .
							esc_html__( 'Please provide additional information below so we may identify which testimonial to remove.', 'testimonial-basics' ),
			'section'     => 'gdpr',
			'tab'         => 'general',
			'default'     => esc_html__( 'You have not selected a testimonial to remove. ', 'testimonial-basics' ) . ' ' .
							esc_html__( 'Please provide additional information below so we may identify which testimonial to remove.', 'testimonial-basics' ),
			'class'       => 'nohtml',
		),
		// Schema Markup.
		...
		'katb_use_honeypot'                    => array(
			'name'        => 'katb_use_honeypot',
			'title'       => __( 'Use honyepot to reduce spam.', 'testimonial-basics' ),
			'type'        => 'checkbox',
			'description' => __( 'Should remove most of the spam without the need of a Captcha.', 'testimonial-basics' ),
			'section'     => 'general',
			'tab'         => 'input',
			'default'     => false,
			'class'       => 'checkbox',
		...
		'katb_use_captcha'                     => array(
			...
			'type'        => 'checkbox',
			'description' => __( 'For more intensive spam protection.', 'testimonial-basics' ),
			'section'     => 'general',
			'tab'         => 'input',
			'default'     => false,
			'class'       => 'checkbox',
		),
		'katb_use_recaptcha'                   => array(
			'name'        => 'katb_use_recaptcha',
			'title'       => __( 'Use Google reCaptcha V2', 'testimonial-basics' ),
			'type'        => 'checkbox',
			'description' => __( 'This is your best Captcha Option. Sign up at ', 'testimonial-basics' ) .
							'https://www.google.com/recaptcha/', // url ok.
			'section'     => 'general',
			'tab'         => 'input',
			'default'     => false,
			'class'       => 'checkbox',
		...
		'katb_site_key'                        => array(
			'name'        => 'katb_site_key',
			'title'       => __( 'reCaptcha V2 Site Key', 'testimonial-basics' ),
			'type'        => 'text',
			'description' => __( 'Enter the site key you received on reCaptcha sign-up.', 'testimonial-basics' ),
			'section'     => 'general',
			'tab'         => 'input',
			'default'     => '',
			'class'       => 'nohtml',
		),
		'katb_secret_key'                      => array(
			'name'        => 'katb_secret_key',
			'title'       => __( 'reCaptcha V2 Secret Key', 'testimonial-basics' ),
			'type'        => 'text',
			'description' => __( 'Enter the secret key you received on reCaptcha sign-up.', 'testimonial-basics' ),
			'section'     => 'general',
			'tab'         => 'input',
			'default'     => '',
			'class'       => 'nohtml',
		...
		'katb_layout_option'                   => array(
			...
			'type'          => 'select',
			'valid_options' => array(
				'Top Meta', // translate ok.
				'Bottom Meta', // translate ok.
				'Side Meta', // translate ok.
				'Mosaic', // translate ok.
			),
			'description'   => __( 'Try them to see what you prefer', 'testimonial-basics' ),
			'section'       => 'content_general',
			'tab'           => 'content_display',
			'default'       => 'Bottom Meta', // translate ok.
			'class'         => 'select',
		),
		'katb_content_font'                    => array(
			...
			'type'          => 'select',
			'valid_options' => array(
				'default font', // translate ok.
				'Georgia, serif', // translate ok.
				'Verdana, Geneva, sans-serif', // translate ok.
				'Arial, Helvetica, sans-serif', // translate ok.
				"'Book Antiqua', 'Palatino Linotype', Palatino, serif", // translate ok.
				'Cambria, Georgia, serif', // translate ok.
				"'Comic Sans MS', sans-serif", // translate ok.
				'Tahoma, Geneva, sans-serif', // translate ok.
				"'Times New Roman', Times, serif", // translate ok.
				"'Trebuchet MS', Helvetica, sans-serif", // translate ok.
			),
			'description'   => __( 'default is theme font', 'testimonial-basics' ),
			'section'       => 'content_general',
			'tab'           => 'content_display',
			'default'       => 'default font', // translate ok.
			'class'         => 'select',
		),
		...
		'katb_widget_layout_option'            => array(
			...
			'valid_options' => array(
				'Top Meta', // translate ok.
				'Bottom Meta', // translate ok.
				'Image & Meta Top', // translate ok.
				'Image & Meta Bottom', // translate ok.
				'Centered Image & Meta Top', // translate ok.
				'Centered Image & Meta Bottom', // translate ok.
			),
			'description'   => __( 'Try them to see what you prefer', 'testimonial-basics' ),
