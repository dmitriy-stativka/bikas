 ...
 * It uses schema, no rotation, image and meta on bottom, and custom or basic formats.
 *
...
<div itemscope itemtype="http://schema.org/Organization">
	...
	<div class="katb_widget_wrap<?php echo esc_attr( $format ); ?> image_meta_bot">
		<?php
		...
		for ( $i = 0; $i < $katb_widget_tnumber; $i++ ) {
			...
			?>
			<div class="katb_widget_box<?php echo esc_attr( $format ); ?>" itemscope itemtype="http://schema.org/Review">
