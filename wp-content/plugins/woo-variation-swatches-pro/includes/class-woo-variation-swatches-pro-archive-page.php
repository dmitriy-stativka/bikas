    ...
    if ( ! class_exists( 'Woo_Variation_Swatches_Pro_Archive_Page' ) ) {
        class Woo_Variation_Swatches_Pro_Archive_Page extends Woo_Variation_Swatches_Pro_Product_Page {
            ...
            protected function hooks() {
                ...
                add_filter( 'woocommerce_loop_add_to_cart_args', array( $this, 'add_button_class' ) );
            ...
            public function add_button_class( $default ) {
                
                $default[ 'class' ] = $default[ 'class' ] . ' wvs-add-to-cart-button';
